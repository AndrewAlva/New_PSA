$(document).ready(function() {
	// INSERT VIMEO VIDEO
		...
		$('#play-button-desktop').click(function(){
			$('#vimeoBox').append('<div id="vimeoVideo"><iframe src="https://player.vimeo.com/video/157361319?autoplay=1&color=0b6c81&title=0&byline=0&portrait=0" width="800" height="450" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>');
		...
		$('#play-button-mobile').click(function(){
			$('#vimeoBox').append('<div id="vimeoVideo"><iframe src="https://player.vimeo.com/video/157361319?autoplay=1&color=0b6c81&title=0&byline=0&portrait=0" width="320" height="180" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>');
